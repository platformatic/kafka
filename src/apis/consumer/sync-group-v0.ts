...
export function createRequest (
  ...
  return Writer.create()
    ...
    .appendArray(
      assignments,
      (w, assignment) => w.appendString(assignment.memberId, false).appendBytes(assignment.assignment, false),
      false,
      false
    )
}
...
export const api = createAPI<SyncGroupRequest, SyncGroupResponse>(14, 0, createRequest, parseResponse, false, false)
