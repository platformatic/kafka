    ...
    topics: reader.readArray((reader, topicIndex) => ({
      ...
      partitions: reader.readArray((reader, partitionIndex) => {
        const parseVoter = () => ({
          ...
          lastFetchTimestamp: reader.readInt64(),
          lastCaughtUpTimestamp: reader.readInt64()
        })
        const partition = {
          ...
          currentVoters: reader.readArray(parseVoter),
          observers: reader.readArray(parseVoter)
        }
...
export const api = createAPI<DescribeQuorumRequest, DescribeQuorumResponse>(55, 1, createRequest, parseResponse)
