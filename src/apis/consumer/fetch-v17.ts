  ...
  return Writer.create()
    ...
    .appendArray(topics, (w, t) => {
      w.appendUUID(t.topicId).appendArray(t.partitions, (w, p) => {
        ...
        if (p.replicaDirectoryId != null) {
          w.appendUnsignedVarInt(1).appendUnsignedVarInt(0).appendUnsignedVarInt(16).appendUUID(p.replicaDirectoryId)
        } else {
...
/*
  Fetch Response (Version: 17) => throttle_time_ms error_code session_id [responses] node_endpoints TAG_BUFFER
