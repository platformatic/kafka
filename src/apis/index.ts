...
export type SendCallback<T> = (error: Error | null, payload?: T | void) => void

export type CallbackArguments<T> = [cb: SendCallback<T>]
...
export function createAPI<RequestArguments extends Array<unknown>, ResponseType> (
  ...
  const api = function api (
    ...
    const cb = typeof args[args.length - 1] === 'function' ? (args.pop() as SendCallback<ResponseType>) : () => {}
