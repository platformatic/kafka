...
import { findCoordinatorV1, Reader, ResponseError, Writer } from '../../../src/index.ts'

const { api, createRequest, parseResponse } = findCoordinatorV1
...
test('parseResponse processes the singular successful response wire fixture', () => {
  ...
  deepStrictEqual(parseResponse(1, 10, 1, reader), {
    throttleTimeMs: 0,
...
test('parseResponse reports coordinator errors from the response wire fixture', () => {
  ...
  throws(() => parseResponse(1, 10, 1, reader), error => {
