...
export const adminConfigsChannel = createTracingChannel<ClientDiagnosticEvent>('admin:configs')
export const adminAclsChannel = createTracingChannel<ClientDiagnosticEvent>('admin:acls')
export const adminOffsetsChannel = createTracingChannel<ClientDiagnosticEvent>('admin:offsets')
...
export const producerTransactionsChannel = createTracingChannel<ClientDiagnosticEvent>('producer:transactions')
