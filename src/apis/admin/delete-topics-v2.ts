...
/*
  DeleteTopics Request (Version: 2) => [topics] timeout_ms
    topics => name
      name => STRING
    timeout_ms => INT32
*/
...
export const api = createAPI<DeleteTopicsRequest, DeleteTopicsResponse>(20, 2, createRequest, parseResponse, false, false)
