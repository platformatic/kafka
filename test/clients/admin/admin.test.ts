...
test('deleteConsumerGroupOffsets should support diagnostic channels', async t => {
  ...
  const verifyDeleteTracingChannel = createTracingChannelVerifier(
    ...
    'client',
    {
      ...
      asyncStart (context: ClientDiagnosticEvent) {
        const result = context.result as TopicPartitions[]
        ok(result)
        strictEqual(Array.isArray(result), true)
      },
      error (context: ClientDiagnosticEvent) {
...
test('listConsumerGroupOffsets should validate options in strict mode', async t => {
  ...
  try {
    await admin.listConsumerGroupOffsets({
      groups: [{ groupId: 'test-group', topics: [{ name: 'test-topic', partitions: [0] }] }],
  ...
  try {
    await admin.listConsumerGroupOffsets({
      groups: [{ groupId: 123, topics: [{ name: 'test-topic', partitions: [0] }] }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('groupId'), true)
  ...
  try {
    await admin.listConsumerGroupOffsets({
      groups: [{ groupId: '', topics: [{ name: 'test-topic', partitions: [0] }] }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('groupId'), true)
  ...
  try {
    await admin.listConsumerGroupOffsets({
      groups: [
        { groupId: 'test-group', topics: [{ name: 'test-topic', partitions: [0] }], invalidProperty: true }
      ] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
  ...
  try {
    await admin.listConsumerGroupOffsets({
      groups: [{ groupId: 'test-group', topics: [{ partitions: [0] }] as any }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('name'), true)
  ...
  try {
    await admin.listConsumerGroupOffsets({
      groups: [{ groupId: 'test-group', topics: [{ name: '', partitions: [0] }] as any }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('name'), true)
  ...
  try {
    await admin.listConsumerGroupOffsets({
      groups: [{ groupId: 'test-group', topics: [{ name: 123, partitions: [0] }] as any }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('name'), true)
  ...
  try {
    await admin.listConsumerGroupOffsets({
      groups: [{ groupId: 'test-group', topics: [{ name: 'test-topic', partitions: [] }] as any }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('partitions'), true)
  ...
  try {
    await admin.listConsumerGroupOffsets({
      groups: [{ groupId: 'test-group', topics: [{ name: 'test-topic', partitions: 'not-an-array' }] as any }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('partitions'), true)
  ...
  try {
    await admin.listConsumerGroupOffsets({
      groups: [
        { groupId: 'test-group', topics: [{ name: 'test-topic', partitions: [0], invalidProperty: true }] as any }
      ] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
  ...
  try {
    await admin.listConsumerGroupOffsets({
      groups: [{ groupId: 'test-group', topics: [{ name: 'test-topic', partitions: ['not-a-number'] }] as any }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('partitions'), true)
  ...
  try {
    await admin.listConsumerGroupOffsets({
      groups: [{ groupId: 'test-group', topics: [{ name: 'test-topic', partitions: [-1] }] as any }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('partitions'), true)
...
test('deleteConsumerGroupOffsets should validate options in strict mode', async t => {
  ...
  try {
    // @ts-expect-error - Intentionally passing invalid options
    await admin.deleteConsumerGroupOffsets({ groupId: 123, topics: [{ name: 'test-topic', partitions: [0] }] })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('groupId'), true)
  }
  ...
  try {
    await admin.deleteConsumerGroupOffsets({
      groupId: 'test-group',
      topics: [{ name: 'test-topic', partitions: ['not-a-number'] }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('partitions'), true)
