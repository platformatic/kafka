...
import * as addPartitionsToTxnV1 from '../../../src/apis/producer/add-partitions-to-txn-v1.ts'
import { ResponseError } from '../../../src/errors.ts'
import { Reader } from '../../../src/protocol/reader.ts'
import { Writer } from '../../../src/protocol/writer.ts'

test('AddPartitionsToTxn v1 serializes and normalizes the legacy schema', () => {
  strictEqual(addPartitionsToTxnV1.api.version, 1)
  const reader = Reader.from(
    addPartitionsToTxnV1.createRequest([
      {
        transactionalId: 'tx',
        producerId: 1n,
        producerEpoch: 2,
  ...
  deepStrictEqual(
    addPartitionsToTxnV1.parseResponse(
      1,
      24,
      1,
      Reader.from(
...
test('AddPartitionsToTxn v1 exposes partition protocol errors', () => {
  ...
  throws(() => addPartitionsToTxnV1.parseResponse(1, 24, 1, Reader.from(response)), ResponseError)
})
