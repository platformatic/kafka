    ...
    .appendArray(
      ...
      (w, topic) => {
        w.appendString(topic.topicId, false).appendArray(
          topic.partitions,
          (w, partition) => w.appendInt32(partition.partition).appendInt64(partition.fetchOffset).appendInt32(partition.partitionMaxBytes),
          false,
          false
        )
      },
...
export const api = createAPI<FetchRequest, FetchResponse>(1, 4, createRequest, parseResponse, false, false)
