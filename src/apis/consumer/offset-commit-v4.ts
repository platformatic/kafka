    ...
    .appendArray(
      ...
      (w, t) => {
        w.appendString(t.name, false).appendArray(
          t.partitions,
          (w, { partitionIndex, committedOffset, committedLeaderEpoch: _committedLeaderEpoch, committedMetadata }) => {
            w.appendInt32(partitionIndex).appendInt64(committedOffset).appendString(committedMetadata, false)
          },
          false,
          false
        )
