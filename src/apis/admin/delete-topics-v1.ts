...
/*
  DeleteTopics Request (Version: 1) => [topics] timeout_ms
    topics => name
      name => STRING
    timeout_ms => INT32
*/
...
export const api = createAPI<DeleteTopicsRequest, DeleteTopicsResponse>(20, 1, createRequest, parseResponse, false, false)
