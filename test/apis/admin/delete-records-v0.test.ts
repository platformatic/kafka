...
import { api, createRequest, parseResponse } from '../../../src/apis/admin/delete-records-v0.ts'
import { Reader } from '../../../src/protocol/reader.ts'
import { Writer } from '../../../src/protocol/writer.ts'

test('DeleteRecords v0 serializes classic fields and parses classic responses', () => {
