...
import { type DeleteAclsResponseFilterResults } from '../../../src/apis/admin/delete-acls-v2.ts'

const { createRequest, parseResponse } = deleteAclsV2
        ...
        w.appendInt16(filterResult.errorCode)
          ...
          .appendArray(filterResult.matchingAcls, (w, matchingAcl) => {
            w.appendInt16(matchingAcl.errorCode)
              ...
              .appendInt8(matchingAcl.resourcePatternType)
