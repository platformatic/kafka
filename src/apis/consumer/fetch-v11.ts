...
export function createRequest (
  ...
  return Writer.create()
    ...
    .appendArray(
      forgottenTopicsData,
      (w, t) => {
        w.appendString(t.topicId ?? t.topic, false).appendArray(
          t.partitions,
          (w, p) => {
            w.appendInt32(p)
          },
...
export const api = createAPI<FetchRequest, FetchResponse>(1, 11, createRequest, parseResponse, false, false)
