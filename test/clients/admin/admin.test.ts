...
test('all operations should fail when admin is closed', async t => {
  ...
  try {
    await admin.describeConfigs({
      resources: [{ resourceType: ConfigResources.TOPIC, resourceName: 'test-topic' }]
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message, 'Client is closed.')
  ...
  try {
    await admin.alterConfigs({
      resources: [{ resourceType: ConfigResources.TOPIC, resourceName: 'test-topic', configs: [] }]
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message, 'Client is closed.')
...
test('describeConfigs should list configs (TOPIC resource type)', async t => {
  ...
  const initialResult = await admin.describeConfigs({
    resources: [
      {
        resourceType: ConfigResources.TOPIC,
  ...
  strictEqual(initialResult[0].resourceType, ConfigResources.TOPIC)
...
test('describeConfigs should properly describe broker configs', async t => {
  ...
  const result = await admin.describeConfigs({
    resources: [
      {
        resourceType: ConfigResources.BROKER,
        resourceName: '1',
        configurationKeys: []
      },
      {
  ...
  strictEqual(result.length, 3)
  strictEqual(
    result.every(r => r.resourceType === ConfigResources.BROKER),
    true
  )
...
test('describeConfigs should validate options in strict mode', async t => {
  ...
  try {
    await admin.describeConfigs({
      resources: [{ resourceType: ConfigResources.TOPIC, configurationKeys: [] }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
  ...
  try {
    await admin.describeConfigs({
      resources: [{ resourceType: ConfigResources.TOPIC, resourceName: 123, configurationKeys: [] }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('resourceName'), true)
  ...
  try {
    await admin.describeConfigs({
      resources: [{ resourceType: ConfigResources.TOPIC, resourceName: '', configurationKeys: [] }]
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('resourceName'), true)
  ...
  try {
    await admin.describeConfigs({
      resources: [
        { resourceType: ConfigResources.TOPIC, resourceName: 'test-topic', configurationKeys: 'not-an-array' }
      ] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
  ...
  try {
    await admin.describeConfigs({
      resources: [{ resourceType: ConfigResources.TOPIC, resourceName: 'test-topic', configurationKeys: [123] }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('configurationKeys'), true)
  ...
  try {
    await admin.describeConfigs({
      resources: [{ resourceType: ConfigResources.TOPIC, resourceName: 'test-topic', configurationKeys: [''] }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('configurationKeys'), true)
...
test('alterConfigs should validate options in strict mode', async t => {
  ...
  try {
    await admin.alterConfigs({
      resources: [
        { resourceType: ConfigResources.TOPIC, configs: [{ name: 'cleanup.policy', value: 'compact' }] }
      ] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
  ...
  try {
    await admin.alterConfigs({
      resources: [{ resourceType: ConfigResources.TOPIC, resourceName: 'test-topic' }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
  ...
  try {
    await admin.alterConfigs({
      resources: [{ resourceType: ConfigResources.TOPIC, resourceName: 'test-topic', configs: 'not-an-array' }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('configs'), true)
...
test('incrementalAlterConfigs should validate options in strict mode', async t => {
  ...
  try {
    await admin.incrementalAlterConfigs({
      resources: [{ resourceType: ConfigResources.TOPIC, configs: [] }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('resourceName'), true)
  ...
  try {
    await admin.incrementalAlterConfigs({
      resources: [{ resourceType: ConfigResources.TOPIC, resourceName: 123, configs: [] }] as any
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('resourceName'), true)
  ...
  try {
    await admin.incrementalAlterConfigs({
      resources: [{ resourceType: ConfigResources.TOPIC, resourceName: '', configs: [] }]
    })
    throw new Error('Expected error not thrown')
  } catch (error) {
    strictEqual(error.message.includes('resourceName'), true)
