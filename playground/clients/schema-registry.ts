...
const producerRegistry = new ConfluentSchemaRegistry({ url: registryUrl })
const consumerRegistry = new ConfluentSchemaRegistry({ url: registryUrl })
...
async function produce (schemaId: number) {
  const producer = new Producer({
    ...
    serializers: producerRegistry.getSerializers(),
    strict: true
  })
