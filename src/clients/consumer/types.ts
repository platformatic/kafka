...
import { type IsolationLevel, type GroupProtocols } from '../../apis/enumerations.ts'
...
export interface ConsumerListOffsetsOptions {
  topics: string[]
...
export type GetLagOptions = Omit<ConsumerListOffsetsOptions, 'timestamp' | 'isolationLevel'>
