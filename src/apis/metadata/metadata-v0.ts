...
export function parseResponse (
  ...
  const response: MetadataResponse = {
    ...
    brokers: reader.readArray(
      r => ({ nodeId: r.readInt32(), host: r.readString(false), port: r.readInt32(), rack: null }),
      false,
      false
    )!,
    clusterId: null,
...
export const api = createAPI<MetadataRequest, MetadataResponse>(3, 0, createRequest, parseResponse, false, false)
